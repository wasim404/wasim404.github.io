...
export default function ProfileModal({ onClose }) {
  ...
  return createPortal(
    ...
    >
      <section
        className="profile-modal relative my-auto flex max-h-[calc(100dvh-2rem)] w-full max-w-[820px] flex-col overflow-hidden rounded-[30px] border border-[#485e91]/15 bg-[#fbfaf6] text-[#27334e] shadow-[0_35px_100px_rgba(30,39,62,0.28)]"
        role="dialog"
        aria-modal="true"
        aria-labelledby="profile-modal-title"
        aria-describedby="profile-modal-description"
      >
        <header className="profile-modal__header flex shrink-0 items-start justify-between gap-5 border-b border-[#384c7d]/10 bg-[#fbfaf6]/95 px-5 py-5 backdrop-blur-xl sm:px-8 sm:py-6">
          <div>
        ...
        <div className="profile-modal__scroll">
          ...
          {loadState === 'loaded' && profile && (
            <div className="profile-modal__content p-4 sm:p-7">
              <div className="profile-sheet">
                ...
                <form className="profile-details" onSubmit={saveDetails}>
                  ...
                  <div className="profile-details__actions flex flex-wrap items-center justify-end gap-3 px-5 py-4 sm:px-6">
